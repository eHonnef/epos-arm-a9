...
// REFERENCIA http://infocenter.arm.com/help/index.jsp?topic=/com.arm.doc.dui0440b/I1007079.html
...
public:
    ...
    enum {
        ...
        GPIOD_BASE                  = 0, // PrimeCell PL061 GPIO (NAO PRESENTE ?)
        ...
        I2C2_BASE                   = 0, // I2C (NAO PRESENTE ?)
        GPIOE_BASE                  = 0, // PrimeCell PL061 GPIO (NAO PRESENTE ?)
        TIMER0_BASE                 = 0x10011000, // GPTM
        TIMER1_BASE                 = 0x10012000, // GPTM
        TIMER2_BASE                 = 0x10018000, // GPTM
        TIMER3_BASE                 = 0x10019000, // GPTM
        ADC0_BASE                   = 0, // ADC (nao presente ?)
        FLASH0_BASE                 = 0x1000004C, // Flash Controller
        SCR_BASE                    = 0x10000000, // System Control
        IC0_BASE                    = 0, // NVIC (nao presente ?)
        TIMER4_BASE                 = 0, // SysTick (nao presente ?)
        IC1_BASE                    = 0, // NVIC (nao presente ?)
    };
